...
/**
 * Provides the local service interface for Mood. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MoodLocalServiceUtil
...
public interface MoodLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MoodLocalServiceUtil} to access the mood local service. Add custom service methods to {@link com.liferay.content.targeting.rule.mood.service.impl.MoodLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Mood addMood(long anonymousUserId, long ruleInstanceId, int moodTtl,
	...
	* @return the new mood
	*/
	public Mood createMood(long moodId);
	...
	*/
	...
	public Mood deleteMood(Mood mood);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Mood deleteMood(long moodId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Mood fetchMood(long anonymousUserId, long ruleInstanceId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Mood fetchMood(long moodId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Mood getMood(long moodId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Mood> getMoods(int start, int end);
